...
class FSRCNN_SMALL_PRETRAIN(nn.Module):
    def __init__(self, scale, num_channels=3, d=56, s=12, m=4):
        ...
        self.last_part = nn.ConvTranspose2d(d, num_channels, kernel_size=9, stride=scale, padding=9//2,
